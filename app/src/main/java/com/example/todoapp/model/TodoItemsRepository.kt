    ...
    companion object{
        var list = mutableListOf<TodoItem>(
            ...
            TodoItem("2","Bro",Importance.LOW,false,
                20231106,20231107,1343805819061),
            TodoItem("3","Местные жители временно дали семье квартиру в долг — сумма растёт, " +
                    "платить нечем. Устроиться на высокооплачиваемую работу они не могут из-за гражданства, " +
                    "а оформление паспортов не в силах потянуть финансово. Семья просит помощи у подписчиков ." +
                    "Местные жители временно дали семье квартиру в долг — сумма растёт, " +
                    "платить нечем. Устроиться на высокооплачиваемую работу они не могут из-за гражданства, " +
                    "а оформление паспортов не в силах потянуть финансово. Семья просит помощи у подписчиков .",
